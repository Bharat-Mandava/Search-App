...
var selectedSuggestionIndex = -1; //Initial Suggestions

var getCountriuesWithBlank = function getCountriuesWithBlank(e) {
  if (!matchList.innerHTML) {
    var matches = ["Ind", "US", "IT", "FR", "NR"];
...
var getcountries = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(searchText) {
    var matches, suggestions, res, country;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            _context.next = 10;
            return _axios.default.get("http://localhost:5000/countrycode?name=".concat(searchText));

          case 10:
            res = _context.sent;
            country = res.data;
            suggestions = country.map(function (e) {
...
var outputHtml = function outputHtml(matches) {
  ...
  if (matches.length > 0) {
    var html = matches.map(function (match) {
      return "\n            <div class=\"searchContainer\"><i class=\"fas fa-search\" ></i>\n            <div style=\"width:100%\" class=\"spanContent\">".concat(match, "</div></div>\n        ");
    }).join('');
...
var outputHtmlHistory = function outputHtmlHistory(matches) {
  matchList.style.display = "flex";

  if (matches.length > 0) {
    var html = matches.map(function (match) {
      return "\n            <div class=\"searchContainerHistory\">\n            <i class='far fa-clock'></i> <div style=\"width:100%\" class=\"spanContent\">".concat(match, "</div>\n            <div class=\"fullremoveHistoryButton\">Remove</div>\n            <div class=\"shortremoveHistoryButton\">X</div>\n            </div>\n        ");
    }).join('');
    matchList.innerHTML = html;
  }
...
var outputTrending = function outputTrending(trendingValues) {
  var html = trendingValues.map(function (value) {
    return "\n    <div class=\"card\">".concat(value, "</div>\n    ");
  }).join('');
...
document.addEventListener('click', function (e) {
  if (e.target.className == 'fullremoveHistoryButton' || e.target.className == 'shortremoveHistoryButton') {
    var confirmation = confirm("Removing this will remove this recent search from your history on all your devices");
...
search.addEventListener("keydown", function (e) {
  ...
  if (e.key == 'ArrowUp') {
    ...
    x.children[selectedSuggestionIndex].classList.add('selected');
    search.value = matchList.children[selectedSuggestionIndex].children[1].innerHTML; // selectedSuggestionIndex = -1;
...
var getTrending = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(trending) {
    var trendingValues, res;
...
search.addEventListener('input', function () {
  return getcountries(search.value);
});
search.addEventListener('click', function () {
  return getCountriuesWithBlank();
}); //Load Trending on window load

window.addEventListener('load', function () {
  return getTrending();
});
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
